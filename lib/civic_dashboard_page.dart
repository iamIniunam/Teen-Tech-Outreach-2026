...
class _CivicDashboardPageState extends State<CivicDashboardPage> {
  ...
  void initState() {
    super.initState();
    _issues = [
      CivicIssue(title: "Fix potholes on Teshie Beach Road", icon: "🕳️", votes: 12),
      CivicIssue(title: "Install solar streetlights near Methodist Church", icon: "💡", votes: 8),
      CivicIssue(title: "Open a free youth coding lab in Accra", icon: "💻", votes: 25),
    ];
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("🗳️ CivicVoice Teshie"),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: _issues.isEmpty
                  ? const Center(child: Text("No reported issues yet. Be the first!"))
                  : ListView.builder(
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ThankYouPage(
                            ...
                            customMessage: "Thank you for advocating, ${widget.schoolName}!",
                          ),
                        ),
                      );
                    },
