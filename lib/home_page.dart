...
class _HomePageState extends State<HomePage> {
  ...
  String get _displaySchool => _schoolName.isEmpty ? "Future Leaders" : _schoolName;
          ...
          child: Column(
            ...
            children: [
              ...
              _buildAppCard(
                ...
                description: "Voice community issues and vote on local solutions in Accra.",
                color: Colors.teal,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CivicDashboardPage(schoolName: _displaySchool),
                    ),
                  );
                },
              ),
              ...
              _buildAppCard(
                ...
                description: "Tap as fast as you can. Change variables to hack the speed!",
                color: Colors.amber.shade800,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SpeedTapGamePage(schoolName: _displaySchool),
                    ),
                  );
                },
              ),
              ...
              _buildAppCard(
                ...
                description: "Design pixel grids and reload custom code palettes live.",
                color: Colors.indigoAccent,
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ArtStudioPage(schoolName: _displaySchool),
                    ),
                  );
                },
              ),
